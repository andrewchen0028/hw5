...
class DDPMScheduler(nn.Module):
    ...
    def __init__(
        ...
        # TODO: timesteps
        timesteps = torch.from_numpy(np.arange(0, num_train_timesteps)[::-1].copy()) # [999, 998, ..., 1, 0]
    ...
    def set_timesteps(
        ...
        timesteps = np.linspace(0, self.num_train_timesteps - 1, num_inference_steps)\
                                .round()[::-1]\
                                .copy()\
                                .astype(np.int64) # [999, 995, 991, ..., 8, 4, 0]
    ...
    def previous_timestep(self, timestep):
        ...
        prev_t = timestep - self.num_train_timesteps // num_inference_steps # e.g. 999 -> 995
        return prev_t
